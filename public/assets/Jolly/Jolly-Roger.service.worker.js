...
/** @type {string} */
const CACHE_VERSION = '1772190244|347139567';
/** @type {string} */
const CACHE_PREFIX = 'Jolly Roger-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'Jolly-Roger.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["Jolly-Roger.html","Jolly-Roger.js","Jolly-Roger.offline.html","Jolly-Roger.icon.png","Jolly-Roger.apple-touch-icon.png","Jolly-Roger.audio.worklet.js","Jolly-Roger.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["Jolly-Roger.wasm","Jolly-Roger.pck"];
