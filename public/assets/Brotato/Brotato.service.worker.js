...
/** @type {string} */
const CACHE_VERSION = '1771971835|1078410994';
/** @type {string} */
const CACHE_PREFIX = 'Brotato Clone-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'Brotato.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["Brotato.html","Brotato.js","Brotato.offline.html","Brotato.icon.png","Brotato.apple-touch-icon.png","Brotato.audio.worklet.js","Brotato.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["Brotato.wasm","Brotato.pck"];
