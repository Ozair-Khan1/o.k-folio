            ...
            <section className="Home-mg">
                <div className="container p-0">
                    <div className="row g-5 g-lg-4 px-0 justify-content-center">
                        <motion.div whileHover={{ scale: 1.015 }} whileTap={{ scale: 1.015 }} transition={{ duration: 0.7, type: 'spring' }} className="col-xl-4 col-md-10 text-break">
                            <div className="card bg-black rounded-4">
                                <div className="card-body">
                                    <div className="card-header border-0 p-5 rounded-top position-relative overflow-hidden bg-card d-flex align-items-center justify-content-center" style={{ height: "320px" }}>
                                        <div className="shape-1"></div>
                                        <div className="shape-2"></div>

                                        <div className="glass-plate d-flex align-items-center justify-content-center shadow-lg">
                                            <span className="text-white fw-semibold display-6" style={{ letterSpacing: "5px" }}>O.K</span>
                                        </div>
                                    </div>
                                    ...
                                    <div className="card-footer p-0 d-flex flex-wrap gap-3">
                                        <MotionLink to='/Contact' whileHover={{ backgroundColor: "#1A1F2C" }} transition={{ duration: 0 }} className="btn border-0 p-3 rounded-3 d-inline-flex align-items-center gap-2 text-white fw-bold" style={{ backgroundColor: "#0D6EFD" }}>
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-trending-up-icon lucide-trending-up"><path d="M16 7h6v6" /><path d="m22 7-8.5 8.5-5-5L2 17" /></svg>
                                            Contact
                                        </MotionLink>
                                    ...
                                    <div className="card-footer p-0 mt-2 py-3">
                                        <ul className="p-0 m-0 list-row d-flex flex-wrap gap-3">
                                            <li className="list-unstyled">
                                                <motion.a href="https://www.facebook.com/ozair.khan.352476" target="_blank" rel="noreferrer" whileHover={{ backgroundColor: "#0D6EFD", color: "white" }} transition={{ duration: 0 }} className="btn border-2 social-link" style={{ color: "#64748B", backgroundColor: "#0E1018" }} aria-label="Facebook">
                                            ...
                                            <li className="list-unstyled">
                                                <motion.a href="https://github.com/Ozair-Khan1" target="_blank" rel="noreferrer" whileHover={{ backgroundColor: "#0D6EFD", color: "white" }} transition={{ duration: 0 }} className="btn border-2 social-link" style={{ color: "#64748B", backgroundColor: "#0E1018" }} aria-label="GitHub">
                                            ...
                                            <li className="list-unstyled">
                                                <motion.a href="https://www.instagram.com/ozair_nvm/" target="_blank" rel="noreferrer" whileHover={{ backgroundColor: "#0D6EFD", color: "white" }} transition={{ duration: 0 }} className="btn border-2 social-link" style={{ color: "#64748B", backgroundColor: "#0E1018" }} aria-label="Instagram">
                        ...
                        <div className="col-xl-4 col-md-10">
                            <motion.div animate={{ opacity: [0, 0.5, 1] }} className="row g-5 g-lg-4 g-xl-4">
                                <motion.div whileHover={{ scale: 1.015 }} whileTap={{ scale: 1.015 }} transition={{ duration: 0.7, type: 'spring' }} className="col-lg-12">
                        ...
                        <motion.div animate={{ x: [500, 0], opacity: [0, 0.5, 1] }} transition={{ duration: 1, type: 'spring' }} whileHover={{ scale: 1.015 }} whileTap={{ scale: 1.015 }} className="col-xl-4 col-md-10 d-flex">
                            <div className="card bg-black h-100 w-100 rounded-4">
                                <div className="card-body d-flex flex-column">
                                    <div className="card-title d-flex align-items-center justify-content-between p-2">
                                        ...
                                        <Link to='/Work'>
                                            <motion.span initial={{ color: 'rgba(13, 110, 253)' }} whileHover={{ borderBottomColor: 'rgba(13, 110, 253)', color: '#576076' }} className="d-inline-flex align-items-center text-decoration-none all-tag">All Projects <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="ms-1 lucide lucide-arrow-right-icon lucide-arrow-right"><path d="M5 12h14" /><path d="m12 5 7 7-7 7" /></svg></motion.span>
                                        </Link>
                                    </div>
                                    <div className="d-flex flex-column flex-grow-1 mt-5">
                                        <div className="row g-4 flex-grow-1">
                                            ...
                                            <div className="col-lg-12 flex-grow-1">
                                                <motion.div onClick={openStarBucks} className="card-img rounded-4 overflow-hidden position-relative p-3 pb-0" style={{ backgroundColor: '#0E1018' }} onMouseEnter={() => setIsHovering(2)} onMouseLeave={() => setIsHovering(0)}>
                        ...
                        <motion.div animate={{ y: [150, 0], opacity: [0, 0.5, 1] }} whileHover={{ scale: 1.015 }} whileTap={{ scale: 1.015 }} transition={{ duration: 0.7, type: 'spring' }} className="col-xl-8">
                            <div className="card bg-black rounded-4">
                                <div className="card-body">
                                    <div className="card-title d-flex align-items-center justify-content-between p-2">
                                        <p className="text-white fw-bolder fs-4 m-0 section-heading">What I Do</p>
                                        <Link to='/Work'>
                                            ...
                                            <div className="col-md-3 col-sm-6 col-6" key={index}>
                                                <div className="service-sec text-center p-3 rounded-4" style={{ backgroundColor: '#0E1018' }}>
                                                    <div className="card-img p-3 rounded-4 bg-black">
                                                        <img src={item.image} alt={item.desc} style={{ height: '72px', width: '72px' }} />
                                                    </div>
                        ...
                        <motion.div animate={{ y: [150, 0], opacity: [0, 0.5, 1] }} whileHover={{ scale: 1.015 }} whileTap={{ scale: 1.015 }} transition={{ duration: 0.7, type: 'spring' }} className="col-xl-4 d-flex flex-grow-1">
                            <div className="card bg-black rounded-4">
                                <div className="card-body p-4">
                                    ...
                                    <h3 className="card-title fw-bolder fs-1 text-white">
                                        Lets 👋
                                        <span className="d-block">Work Together</span>
                                    </h3>
                                    <div className="card-footer ps-0">
                                        <Link to='/Contact'><motion.span initial={{ color: 'rgba(13, 110, 253)' }} whileHover={{ borderBottomColor: 'rgba(13, 110, 253)', color: '#576076' }} className="d-inline-flex align-items-center text-decoration-none all-tag">Contact <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-trending-up-icon lucide-trending-up"><path d="M16 7h6v6" /><path d="m22 7-8.5 8.5-5-5L2 17" /></svg></motion.span>
                                        </Link>
                                    </div>
                                </div>
                            </div>
