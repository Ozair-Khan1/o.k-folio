                        ...
                        <nav className="navbar bg-transparent">
                            ...
                            <div className="main justify-content-center d-none d-lg-flex d-xl-flex flex-grow-1">
                                ...
                                <div className="d-flex gap-3 align-items-center d-none d-lg-flex d-xl-flex">
                                    <motion.a href="/assets/OZAIR-KHAN-CV-V3.pdf" download="OZAIR-KHAN-CV-V3.pdf" className="btn text-white border-0 py-3 px-4 d-inline-flex gap-2" whileHover={{ backgroundColor: "#0D6EFD" }} transition={{ duration: 0, ease: easeInOut }} style={{ backgroundColor: "#0E1018" }}>
